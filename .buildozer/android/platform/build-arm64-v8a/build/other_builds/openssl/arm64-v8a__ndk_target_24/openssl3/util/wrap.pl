...
BEGIN {
    ...
    require '/home/amir/HamResanAndroid/.buildozer/android/platform/build-arm64-v8a/build/other_builds/openssl/arm64-v8a__ndk_target_24/openssl3/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/amir/HamResanAndroid/.buildozer/android/platform/build-arm64-v8a/build/other_builds/openssl/arm64-v8a__ndk_target_24/openssl3/test/fips-and-base.cnf';
    shift;
